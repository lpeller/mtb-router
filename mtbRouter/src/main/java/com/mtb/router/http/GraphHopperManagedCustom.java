...
public class GraphHopperManagedCustom implements Managed {

    private final static Logger logger = LoggerFactory.getLogger(GraphHopperManagedCustom.class);
    private final GraphHopper graphHopper;

    public GraphHopperManagedCustom(GraphHopperConfig configuration) {
